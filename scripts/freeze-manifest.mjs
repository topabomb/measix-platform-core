...
const scenarioResults = [
  ...
  { id: 'CAP-C6-004-ENH', name: 'Enhanced No-Forward + Usage Generation', file: 'recovery_test.go', required: true },
  { id: 'CAP-C6-010', name: 'Hub Crash Around Publish', file: 'recovery_test.go', required: true },
  ...
  { id: 'CAP-C6-013', name: 'SQLite Busy/Transient', file: 'recovery_test.go', required: true },
